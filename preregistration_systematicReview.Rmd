...
* Starting: 26. June 2023
* Anticipated completion date: 15. October 2023 (without manuscript)
...
To address this gap, we propose conducting a systematic review to identify and categorize the factors that contribute to the sharing or reusing of video research data in education. We will situate these factors within a "research ecosystem" framework (European Commission, 2018, p. 10), which encompasses the scientific community's context (e.g. incentives, norms, policies of scientific societies), available infrastructure (e.g. discipline specific data centers), the researchers themselves (e.g. awareness, skills), and their video research data (e.g. study design, vulnerable sample; see Fig. 1). By undertaking this review, we aim to enhance awareness and understanding of these factors, ultimately reducing barriers and expanding facilitators for sharing and reusing video research data in education.


![](www/model.png){width=70%}
...
2. Where can these factors be located in a system between context, infrastructure, researchers and data?
...
The latter are often part of documents addressing a broader topic (such as a survey on open science practices). Therefore we will 
...
* The document mentions barriers or facilitators to sharing or reusing research data

__Exclusion:__

* The data does not include human subjects
...
* The document includes statements about sharing or reusing research data
* These statements concern qualitative data or video data
* The document mentions barriers or facilitators to sharing or reusing research data
...
* Web of Science
* ERIC
* first 100 results of google scholar (to check for grey literature)
...
* Screening and coding: rayyan.ai or asreview.nl
...
* barriers and facilitators
  ...
  - Where we assign the barrier or facilitator (context, infrastructure, researcher, data, other)? 
